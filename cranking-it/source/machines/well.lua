-- CRANKING IT :: No.10 THE WELL (placeholder - to be implemented)
local gfx <const> = playdate.graphics
local M = Machine.define({
  id = "well", number = 10, title = "THE WELL", tagline = "Coming soon.",
...
function M:draw() gfx.clear(gfx.kColorWhite) UI.header(10, "THE WELL", "") end
