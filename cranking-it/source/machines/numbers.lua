-- CRANKING IT :: No.5 NUMBERS STATION (placeholder - to be implemented)
local gfx <const> = playdate.graphics
local M = Machine.define({
  id = "numbers", number = 5, title = "NUMBERS STATION", tagline = "Coming soon.",
...
function M:draw() gfx.clear(gfx.kColorWhite) UI.header(5, "NUMBERS STATION", "") end
